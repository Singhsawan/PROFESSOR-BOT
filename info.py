...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6201745002').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://boy785359:E5ZvQHAg7iZA67tD@cluster0.iysidtt.mongodb.net/?retryWrites=true&w=majority")
...
# url shortner
SHORT_URL = environ.get("http://ziplinker.net")
SHORT_API = environ.get("fe322d19238465dd864fe652113180a4c8001910")

# Others
IMDB_DELET_TIME = int(environ.get('IMDB_DELET_TIME', "300"))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL',  -1001971836936))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'movie_adda_request_group')
